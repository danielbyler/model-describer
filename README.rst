...
.. image:: https://github.com/DataScienceSquad/WhiteBox_Production/blob/master/images/Impact_Gif.gif
...
.. image:: https://github.com/DataScienceSquad/WhiteBox_Production/blob/master/images/Error_Gif.gif

For a more detailed example, see our `example notebook <https://github.com/DataScienceSquad/WhiteBox_Production/blob/master/docs/notebooks/WineQuality_Example.ipynb>`_ and `parameter list here <https://github.com/DataScienceSquad/WhiteBox_Production/tree/master/docs>`_.
...
.. code-block:: python
    ...
    # and then create your modelling dataframe, create dummies, build model, and specify whitebox
