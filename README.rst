...
`full notebook here https://github.com/Data4Gov/WhiteBox/blob/master/Example_Notebook/Random%20Forest%20Analysis.ipynb`_, all you have to do to produce the interactive chart is this line of code: 
